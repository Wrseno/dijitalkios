...
const PaymentCard = ({ payments, product }) => {
  ...
  return (
    <>
      <section className='container max-w-screen-xl mx-auto'>
        <div className='py-6'>
          <h1 className='text-center text-slate-700 font-semibold'>
            BAYAR SEBELUM {tomorrow}
          </h1>
          <p className='text-center text-sm text-slate-700 font-semibold mb-8'>
            Informasi! Untuk Metode Pembayaran Selain Dana, SeaBank, ShopeePay.
            (Gopay, Link Aja, dan Rekening) Saat Ini Belum Bisa.
          </p>
              ...
              <div className='border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-slate-50 outline-none focus:outline-none'>
                ...
                <div className='relative p-6 flex-auto text-center'>
                  ...
                  <p className='text-slate-600 leading-relaxed'>
                    ...
                    harga. Kemudian klik konfirmasi. Terimakasih telah order di
                    - dijitalkios.
                  </p>
                </div>
                {/*footer*/}
