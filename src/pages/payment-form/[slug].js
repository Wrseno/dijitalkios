                        ...
                        <div className='bg-white shadow-lg p-4 my-6 rounded-md'>
                          ...
                          <div className='text-left'>
                            ...
                            <p className='text-sm text-slate-500'>
                              Kemungkinan untuk e-wallet namanya ada yang
                              berbeda.
                            </p>
                          </div>
                        </div>
                        <p className='text-slate-600 leading-relaxed'>
                          Silahkan transfer ke nomor yang telah ada, transfer
                          sesuai harga. Kemudian klik konfirmasi. Terimakasih
                          telah order di - dijitalkios.
                        </p>
                      </div>
                      {/*footer*/}
